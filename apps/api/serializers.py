...
class SubCategorySerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = SubCategory
        fields = ['id', 'name', 'slug', 'description', 'subsubcategories']
...
class ArticleSectionSerializer(serializers.ModelSerializer):
    class Meta:
        ...
        fields = ['id', 'title', 'content', 'order', 'is_expanded_default']

class ArticleMediaSerializer(serializers.ModelSerializer):
    class Meta:
        model = ArticleMedia
        fields = ['id', 'media_type', 'label', 'text_content', 'image', 'audio_file', 'video_file', 'youtube_url', 'order']

class InteractiveTermSerializer(serializers.ModelSerializer):
    class Meta:
        model = InteractiveTerm
        fields = ['id', 'term', 'slug', 'explanation', 'image', 'audio_file', 'external_link']
...
class ArticleListSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Article
        fields = ['id', 'title', 'subtitle', 'slug', 'author', 'category_name', 'cover_image', 'excerpt', 'published_at', 'view_count', 'tags']
...
class ArticleDetailSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Article
        fields = ['id', 'title', 'subtitle', 'slug', 'author', 'cover_image', 'body', 'excerpt', 
                  'published_at', 'view_count', 'tags', 'sections', 'media', 'terms',
